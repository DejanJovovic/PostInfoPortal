...
export const extractPostId = (n?: OneSignalLike, evt?: any): string | undefined => {
...
export const extractCategoryName = (n?: OneSignalLike, evt?: any): string | undefined => {
    const fromData = n?.additionalData?.category || n?.additionalData?.categoryName;
    if (fromData) return String(fromData);
